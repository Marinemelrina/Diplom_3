...
class MainPageLocators:
    WELCOME_BUTTON = (By.XPATH, '//button[text()="Войти в аккаунт"]')  # кнопка "Войти в аккаунт"
    CREATE_BURGER_HEADER = (By.XPATH, '//h1[text()="Соберите бургер"]')  # заголовок "Соберите бургер"
    ...
    ORDER_STATUS = (By.XPATH, '//p[text()="Ваш заказ начали готовить"]')  # "Ваш заказ начали готовить" в
    # всплывающем окне
    CLOSE_BUTTON = (By.XPATH, '//button[contains(@class,"close")]')  # кнопка закрытия всплывающего окна
    INGREDIENT_BUTTON = (By.XPATH, '//*[@href="/ingredient/61c0c5a71d1f82001bdaaa6d"]')  # ингридиент "Флюоресцентная
    # булка R2-D3"
    ...
    INGREDIENT_COUNTER = (By.XPATH, '//*[@href="/ingredient/61c0c5a71d1f82001bdaaa6f"]//p[contains(@class, '
                                    '"counter__num")]')  # счетчик ингредиента
    ...
    INGREDIENT_CONTAINER = (By.XPATH, '//ul[contains(@class,"BurgerConstructor_basket")]') # корзина заказа